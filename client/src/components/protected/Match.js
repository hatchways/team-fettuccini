...
class Match extends Component {
  ...
  setUser = async (player, pos) => {
    ...
    let currPos = "";
    if (pos === "RS" && this.state.RS === this.state.userId)
      currPos = this.state.RS;
    else if (pos === "RF" && this.state.RF === this.state.userId)
      currPos = this.state.RF;
    else if (pos === "BS" && this.state.BS === this.state.userId)
      currPos = this.state.BS;
    else if (pos === "BF" && this.state.BF === this.state.userId)
      currPos = this.state.BF;
  ...
  render() {
    ...
    const { classes, setIsMatchInProgres, blueScore, redScore } = this.props;
    const {
      words,
      positionState,
      matchId,
    ...
    return (
      <div className={classes.matchStyle}>
        <ChatBox
        ...
        <div className={`${classes.paper} ${classes.centerText}`}>
          ...
          {["RF", "BF"].includes(matchDictionary[positionState]) ? (
